...
content = content.replace(
    ...
    "{lang === 'ar' ? 'بحبك قد كل مره دعيت فيها تكون من نصيبي يا اغلي من روحي بحبك يا سيد الرجاله♥️' : 'Every star in the sky bears witness to my love... You light up my world.'}"
);
...
const envTarget = "{isGrowing && <FancyText text={lang === 'ar' ? finalMessageAR : finalMessageEN} />}";
const envRepl = `{isGrowing && (
                                        <>
...
// Hero Text
const heroTarget = `<h1 className="text-6xl md:text-8xl font-serif font-black mb-6 leading-tight drop-shadow-[0_0_30px_rgba(255,255,255,0.3)] text-white">
                                        بصمة <span className="text-[rgb(196,13,116)] italic">&</span> الابداع
                                    </h1>`;
const heroRepl = `<h1 className="text-6xl md:text-8xl font-serif font-black mb-6 leading-tight drop-shadow-[0_0_30px_rgba(255,255,255,0.3)] text-white">
...
// Final Scene
const finalScene1 = `<h1 className="text-4xl xs:text-6xl md:text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 animate-pulse-slow mb-8 px-4">
                                    بصمة
                                </h1>`;
const finalScene1Repl = `<h1 className="text-4xl xs:text-6xl md:text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 animate-pulse-slow mb-8 px-4">
                                    الاء و علاء
                                </h1>`;
